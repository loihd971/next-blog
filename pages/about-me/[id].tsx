  ...
  const getUserDetail = async () => {
    try {
      const res = await axios.get(
        `${process.env.BLOG_URL}/api/user/${router.query.id}`
      );
      setUser(res.data);
    } catch (error) {}
  };
...
//   try {
//     const res = await axios.get(`${process.env.BLOG_URL}/api/user/${params.id}`);
...
//   try {
//     const res: any = await axios.get(`${process.env.BLOG_URL}/api/user`);
